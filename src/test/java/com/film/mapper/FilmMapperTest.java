...
public class FilmMapperTest {
	...
	public void testSave() {
		...
		Film film = new Film("金刚狼3", "", "2017", "动作/剧情", "英文", 
				"中英双字", "詹姆斯·曼高德", "休·杰克曼", "2017", new Date(), "","20171015001","5号VIP厅","0");
		Film film2 = new Film("神偷奶爸3", "", "2017", "喜剧/动画/冒险", "英文", 
				"中英双字", "凯尔·巴尔达  Kyle Balda", "史蒂夫·卡瑞尔 Steve Carell", "2017", new Date(), "","20171015002","1号IMAX厅","0");
